...
<body>
	<div class="container">
		<header>
			<p>
			<h1>AcademicYear</h1>
			<a href="addacademicyear.php"> + Add New</a>
			</p>
			<hr>
		</header>
        ...
        if($result->num_rows > 0)
        {
			echo "<thead>
					<tr>
                    	<th>"."AcademicYear"."</th>
                    	<th>"."AcademicYearCreatedAt"."</th>
                    	<th>"."AcademicYearEndAt"."</th>
                    	<th>"."Action"."</th>
                    </tr>
					</thead>"
            	;
            ...
            foreach($result as $row)
            {
				...
				echo "<tr>".
                        ...
                        "<td>".$row['AcademicYearCreatedAt']."</td>".                              
                        "<td>".$row['AcademicYearEndAt']."</td>".                            
                        "<td>"."<a href=\"editacademicyear.php?AcademicYearID=".$user->encrypt($row['AcademicYearID'])."\" class=\"button\" style=\"background-color: #4CAF50;padding:10px;margin:0px;\">Edit</a> <a href=\"deleteacademicyear.php?AcademicYearID=".$row['AcademicYearID']."\" class=\"button\" style=\"background-color: #f44336; padding:10px; margin:0px; \">Delete</a> "."</td>".                                                           
                     "</tr>";
