...
<body>
	<div class="container">
		<header>
			<p>
			<h1>Subject</h1>
			<a href="addsubject.php"> + Add New</a>
			</p>
			<hr>
		</header>
        ...
        if($result->num_rows > 0)
        {
            ...
            foreach($result as $row)
            {
				...
				echo "<tr>".
                        ...
                        "<td>"."<a href=\"editsubject.php?SubjectID=".$user->encrypt($row['SubjectID'])."\" class=\"button\" style=\"background-color: #4CAF50;padding:10px;margin:0px;\">Edit</a> <a href=\"deletesubject.php?SubjectID=".$row['SubjectID']."\" class=\"button\" style=\"background-color: #f44336; padding:10px; margin:0px;\">Delete</a> "."</td>".                                                           
                     "</tr>";
