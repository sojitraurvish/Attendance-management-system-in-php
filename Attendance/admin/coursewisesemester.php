...
<body>
	<div class="container">
		<header>
			<p>
			<h1>Course Wise Semester</h1>
			<a href="addcoursewisesemester.php"> + Add New</a>
			</p>
			<hr>
		</header>
		...
		<?php
		$q="SELECT
                    tbl_course_semester.CourseSemesterID,
                    tbl_academicyear.AcademicYear,
                    tbl_course.CourseName,
                    tbl_semester_divition.SemesterName,
                    tbl_semester_divition.DivitionName,
                    tbl_course_semester.SemesterCreatedDate,
                    tbl_course_semester.SemesterEndDate
            FROM
                    `tbl_course_semester`
        ...
        if($result->num_rows > 0)
        {
			echo "<thead>
					<tr>
                    	<th>"."AcademicYear"."</th>
                    	<th>"."CourseName"."</th>
                    	<th>"."SemesterDivitionName"."</th>
                    	<th>"."SemesterCreatedDate"."</th>
                    	<th>"."SemesterEndDate"."</th>
                    	<th>"."Action"."</th>
                    </tr>
					</thead>"
            	;
            ...
            foreach($result as $row)
            {
				...
				echo "<tr>".
                        ...
                        "<td>".$row['SemesterName']."-".$row['DivitionName']."</td>".                                                                                                                
                        "<td>".$row['SemesterCreatedDate']."</td>".                                                         
                        "<td>".$row['SemesterEndDate']."</td>".                                                         
                        "<td>"."<a href=\"editcoursewisesemester.php?CourseSemesterID=".$user->encrypt($row['CourseSemesterID'])."\" class=\"button\" style=\"background-color: #4CAF50;padding:10px;margin:0px;\">Edit</a> <a href=\"deletecoursewisesemester.php?CourseSemesterID=".$row['CourseSemesterID']."\" class=\"button\" style=\"background-color: #f44336; padding:10px; margin:0px;\">Delete</a> "."</td>".                                                           
                     "</tr>";
