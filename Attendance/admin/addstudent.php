            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="myType" readonly value="S" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <label>User Created At</label>
                        <input type="date" name="myCreateDate" required />
                    </td>
                </tr>
                ...
                <!-- <tr>
                    <td>
                        ...
                        <input type="text" name="myEnro" pattern="[A-Za-z]{2,30}" maxlength="30" required />
                    </td>
                </tr> -->
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label>Dob</label>
                        <input type="date" name="myDOB" required />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label>City</label>
                        <input type="text" name="myCity" maxlength="255" pattern="[a-zA-Z]{2,255}" required />
                    </td>
                </tr>
                <tr>
                    <td>
                        <label>State</label>
                        <input type="text" name="myState" maxlength="255" pattern="[a-zA-Z]{2,255}" required />
                    </td>
                </tr>
                <tr>
                    <td>
