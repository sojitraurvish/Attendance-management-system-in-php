...
<body>
	<div class="container">
		<header>
			<p>
			<h1>Semester wise Subject</h1>
			<a href="addsemesterwisesubject.php"> + Add New</a>
			</p>
			<hr>
		</header>
        ...
        if($result->num_rows > 0)
        {
			echo "<thead>
					<tr>
                        ...
                        <th>"."SubjectType"."</th>
                        <th>"."SubjectCreatedDate"."</th>
                        <th>"."SubjectEndDate"."</th>
                    	<th>"."Action"."</th>
                    </tr>
					</thead>"
            	;
            ...
            foreach($result as $row)
            {
				...
				echo "<tr>".
                        ...
                        "<td>".$row['SubjectCreatedDate']."</td>".                                                                                                              
                        "<td>".$row['SubjectEndDate']."</td>".                                                                                                              
                        "<td>"."<a href=\"editsemesterwisesubject.php?SemesterSubjectID=".$user->encrypt($row['SemesterSubjectID'])."\" class=\"button\" style=\"background-color: #4CAF50;padding:10px;margin:0px;\">Edit</a> <a href=\"deletesemesterwisesubject.php?SemesterSubjectID=".$row['SemesterSubjectID']."\" class=\"button\" style=\"background-color: #f44336; padding:10px; margin:0px; \">Delete</a> "."</td>".                                                           
                     "</tr>";
