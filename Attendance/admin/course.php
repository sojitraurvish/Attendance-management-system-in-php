        ...
        if($result->num_rows > 0)
        {
            ...
            foreach($result as $row)
            {
				...
				echo "<tr>".
                        ...
                        "<td>".$row['CourseCreatedAt']."</td>".                              
                        "<td>"."<a href=\"editcourse.php?CourseID=".$user->encrypt($row['CourseID'])."\" class=\"button\" style=\"background-color: #4CAF50;padding:10px;margin:0px;\">Edit</a> <a href=\"deletecourse.php?CourseID=".$row['CourseID']."\" class=\"button\" style=\"background-color: #f44336; padding:10px; margin:0px;\">Delete</a> "."</td>".                                                           
                     "</tr>";
