...
<div id="mySidenav" class="sidenav">
  ...
  <!-- <button class="dropdown-btn"><i class="far fa-plus-square"> Lecature Entry</i> 
  ...
  <a href="lactureentry.php" ><i class="fas fa-calendar-day">  Lecature Entry</i> </a>
  <a href="#" ><i class="fas fa-calendar-day">  Attendance Report</i> </a>
...
<div class="main2">
	<div class="topnav" id="myTopnav">
        ...
        <div class="topnav-right">
            <div class="dropdown">
                <button class="dropbtn"><i class="fas fa-users-cog"> Faculty</i>
                <i class="fa fa-caret-down"></i>
                </button>
                <div class="dropdown-content">
                <a href="facultyprofile.php"><i class="far fa-id-badge"> Profile</i> </a>
